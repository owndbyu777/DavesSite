...
namespace DavesSite.PCT {
    public class Data {
        ...
        public Data(int id, DatabaseConnection cnn = null) {
            var didOpen = false;
            if (cnn == null) {
                cnn = new DatabaseConnection(Databases.PCT);
                didOpen = true;
            }
        ...
        public static List<Data> GetObjectsWhere(string sqlWhereClause, DatabaseConnection cnn = null) {
            try {
                ...
                while (rdr.Read()) {
                    ...
                    //long.TryParse(rdr["d_ID"].ToString(), out d.d_ID);
                    //decimal.TryParse(rdr["d_Temp"].ToString(), out d.d_Temp);
                    //decimal.TryParse(rdr["d_Humi"].ToString(), out d.d_Humi);
                    //int.TryParse(rdr["d_SoilM"].ToString(), out d.d_SoilM);
